...
export const brandKit: BrandKit = {
    bios: [
        ...
        `${STATS.role}, co-founder at [Cleve](https://cleve.ai).`,

        // Level 1: Add CTO title
        `${STATS.role}, co-founder & CTO at [Cleve](https://cleve.ai).`,

        // Level 2: Add speaking link
        `${STATS.role}, co-founder & CTO at [Cleve](https://cleve.ai). [Speaker](/speaking) on AI and tech.`,

        // Level 3: Add user impact
        `${STATS.role}, co-founder & CTO at [Cleve](https://cleve.ai). [Speaker](/speaking) on AI and tech. ${STATS.users} users reached.`,

        // Level 4: Add talk count
        `${STATS.role}, co-founder & CTO at [Cleve](https://cleve.ai). [Speaker](/speaking) on AI, tech, and career. ${STATS.users} users, [${STATS.talks} talks](/speaking).`,

        // Level 5: Add social following and interests
        `${STATS.role}, co-founder & CTO at [Cleve](https://cleve.ai). [Speaker](/speaking) on AI, tech, and career. ${STATS.users} users, [${STATS.talks} talks](/speaking), ${STATS.followers} followers. I also [read](/books), [write](/blog), and [watch movies](/movies).`,

        // Level 6: Expand to sentence form, add "Rashad is"
        `Rashad is an ${STATS.role} and co-founder & CTO at [Cleve](https://cleve.ai), building AI tools for ${STATS.users} users. He's a [speaker](/speaking) on AI and tech with [${STATS.talks} talks](/speaking) delivered. He also likes to [read](/books), [write](/blog), and [watch movies](/movies).`,

        // Level 7: Add more context to role
        `Rashad is an ${STATS.role} and co-founder & CTO at [Cleve](https://cleve.ai), where he builds AI-powered tools that have reached ${STATS.usersLong} users. He's a [speaker](/speaking) on AI, technology, and career development, with [${STATS.talks} talks](/speaking) delivered and ${STATS.followersLong} followers. He also likes to [read](/books), [write](/blog), and [watch movies](/movies).`,

        // Level 8: Add "try new things" link
        `Rashad is an {highlight:${STATS.role}} and co-founder & CTO at {underline:[Cleve](https://cleve.ai)}, where he builds AI-powered tools that have reached {circle:${STATS.usersLong} users}. He's a [speaker](/speaking) on AI, technology, and career development, with [${STATS.talks} talks](/speaking) delivered and a growing audience of ${STATS.followersLong} followers.\n\nIn his free time, he likes to [try new things](/hobbies), [dive](/diving), [read](/books), [write](/blog), and [watch movies](/movies).`,

        // Level 9: Add entrepreneur label and journey intro
        `Rashad is an {highlight:${STATS.role}} and entrepreneur, co-founder & CTO at {underline:[Cleve](https://cleve.ai)}, where he builds AI-powered tools that have reached {circle:${STATS.usersLong} users}.\n\n[His journey](/about) started early - he began {highlight:hacking at 11} and {highlight:entered university at 15}. He's passionate about [speaking](/speaking) on AI and tech ([${STATS.talks} talks](/speaking)) and sharing what he learns.\n\nIn his free time, he likes to [try new things](/hobbies), [dive](/diving), [read](/books), [write](/blog), and [watch movies](/movies).`,

        // Level 10: Add more journey milestones
        `Rashad is an {highlight:${STATS.role}} and entrepreneur, co-founder & CTO at {underline:[Cleve](https://cleve.ai)}, building AI-powered products that have impacted over {circle:${STATS.usersLong} users}.\n\n[His journey](/about) started early - {highlight:hacking at 11}, {highlight:entering university at 15}, publishing his first game at 16, and working at a startup by 17. He's [passionate about sharing knowledge](/about) through [public speaking](/speaking), having delivered {box:[${STATS.talks} talks](/speaking)}.\n\nIn his free time, he likes to [try new things](/hobbies), [dive](/diving), [read](/books), [write](/blog), and [watch movies](/movies).`,

        // Level 11: Add MIT research and valedictorian
        `Rashad is an {highlight:${STATS.role}} and entrepreneur, co-founder & CTO at {underline:[Cleve](https://cleve.ai)}, building AI-powered products that have impacted over {circle:${STATS.usersLong} users}.\n\n[His journey](/about) started early - {highlight:hacking at 11}, {highlight:entering university at 15}, publishing his first game at 16, and working at a startup by 17. At 19, he {box:published research with MIT}. He graduated as {highlight:valedictorian at 20}.\n\nRashad is passionate about sharing knowledge through [public speaking](/speaking), having delivered {box:[${STATS.talks} talks](/speaking)} on AI, technology, and career development.\n\nIn his free time, he likes to [try new things](/hobbies), [dive](/diving), [read](/books), [write](/blog), and [watch movies](/movies).`,

        // Level 12: Add founding milestones
        `Rashad is an ${STATS.role} and entrepreneur, co-founder & CTO at [Cleve](https://cleve.ai), building AI-powered products that have impacted over ${STATS.usersLong} users.\n\n[His journey](/about) started early - hacking at 11, entering university at 15, publishing his first game at 16, and working at a startup by 17. At 19, he published research with MIT on CreativeGAN. He graduated as valedictorian at 20, founded an AI consulting company at 21, and co-founded his current venture-backed startup at 22.\n\nRashad is passionate about sharing knowledge through [public speaking](/speaking), having delivered [${STATS.talks} talks](/speaking) on AI, technology, and career development.\n\nIn his free time, he likes to [try new things](/hobbies), [dive](/diving), [read](/books), [write](/blog), and [watch movies](/movies).`,

        // Level 13: Add content creator detail
        `Rashad is an {highlight:${STATS.role}} and entrepreneur, co-founder & CTO at {underline:[Cleve](https://cleve.ai)}, building AI-powered products that have impacted over {circle:${STATS.usersLong} users}.\n\n[His journey](/about) started early - {highlight:hacking at 11}, {highlight:entering university at 15}, publishing his first game at 16, and working at a startup by 17. At 19, he {box:published research with MIT} on CreativeGAN. He graduated as {highlight:valedictorian at 20}, founded an AI consulting company at 21, and co-founded his current venture-backed startup at 22.\n\nRashad is passionate about sharing knowledge through [public speaking](/speaking), having delivered {box:[${STATS.talks} talks](/speaking)} on AI, technology, career development, and startups. He's also a [content creator on TikTok](/create) with {circle:${STATS.views} views}.\n\nIn his free time, he likes to [try new things](/hobbies), [dive](/diving), [read](/books), [write](/blog), and [watch movies](/movies).`,

        // Level 14: Add hackathon judging
        `Rashad is an ${STATS.role} and entrepreneur, co-founder & CTO at [Cleve](https://cleve.ai), building AI-powered products that have impacted over ${STATS.usersLong} users.\n\n[His journey](/about) started early - hacking at 11, entering university at 15, publishing his first game at 16, and working at a startup by 17. At 19, he published research with MIT on CreativeGAN. He graduated as valedictorian at 20, founded an AI consulting company at 21, and co-founded his current venture-backed startup at 22.\n\nRashad is passionate about sharing knowledge through [public speaking](/speaking), having delivered [${STATS.talks} talks](/speaking) on AI, technology, career development, and startups. He's also a [content creator on TikTok](/create) with ${STATS.views} views and [judges hackathons](/hackathons) to support the next generation of builders. He also runs [buildforpublic.com](https://buildforpublic.com), a social initiative promoting AI literacy and open-source AI projects for social good.\n\nIn his free time, he likes to [try new things](/hobbies), [dive](/diving), [read](/books), [write](/blog), and [watch movies](/movies).`,

        // Level 15: Add educator label and expand introduction
        `Rashad is an {highlight:${STATS.role}}, entrepreneur, and educator who has been building with technology since {highlight:age 11}. He is currently the co-founder & CTO at {underline:[Cleve](https://cleve.ai)}, where he leads the development of AI-powered tools that have reached over {circle:${STATS.usersLong} users}.\n\n[His journey](/about) started early - {highlight:hacking at 11}, {highlight:entering university at 15}, publishing his first game at 16, and working at a startup by 17. At 19, he {box:published research with MIT} on CreativeGAN. He graduated as {highlight:valedictorian at 20}, founded an AI consulting company at 21, and co-founded his current venture-backed startup at 22.\n\nRashad is passionate about sharing knowledge through [public speaking](/speaking), having delivered {box:[${STATS.talks} talks](/speaking)} on AI, technology, career development, and startups. He's also a [content creator on TikTok](/create) with {circle:${STATS.views} views} and [judges hackathons](/hackathons) to support the next generation of builders. He also runs [buildforpublic.com](https://buildforpublic.com), a social initiative promoting AI literacy and open-source AI projects for social good.\n\nIn his free time, he likes to [try new things](/hobbies), [dive](/diving), [read](/books), [write](/blog), and [watch movies](/movies).`,

        // Level 16: Add /about link and section headers
        `Rashad is an ${STATS.role}, entrepreneur, and educator who has been building with technology since age 11. He is currently the co-founder & CTO at [Cleve](https://cleve.ai), where he leads the development of AI-powered tools that have reached over ${STATS.usersLong} users globally. [Learn more about him](/about).\n\n**Early Journey**\n[His unconventional path](/about) started with hacking at age 11, followed by entering university at 15. By 16, he had published his first game, and at 17, secured his first tech internship at a startup. At 19, he published research on CreativeGAN with MIT, presented at ASME IDETC/CIE 2021. He graduated at 20 as valedictorian, earning four academic awards.\n\n**Entrepreneurship**\nAt 21, Rashad founded an AI consulting company, helping businesses implement AI solutions. At 22, he co-founded Cleve, a venture-backed startup focused on AI-powered productivity tools.\n\n**Speaking & Community**\nRashad is [passionate about education and community building](/about). He has [delivered ${STATS.talks} talks](/speaking) on AI, technology, and career development. He's also a [content creator on TikTok](/create) with ${STATS.followers} followers and ${STATS.views} views, and regularly [judges hackathons](/hackathons).\n\n**Personal**\nHe enjoys [trying new things](/hobbies), [diving](/diving), [reading](/books), [writing](/blog), and [watching movies](/movies).`,

        // Level 17: Add more links (/projects, /resources) and expand sections
        `Rashad is an ${STATS.role}, entrepreneur, and educator who has been building with technology since age 11. He is currently the co-founder & CTO at [Cleve](https://cleve.ai), where he leads the development of [AI-powered tools](/projects) that have reached over ${STATS.usersLong} users globally. [Learn more about him](/about) or check out [what he's up to now](/now).\n\n**Early Journey**\n[His unconventional path](/about) started with hacking at age 11, followed by entering university at 15 - making him one of the youngest students in his cohort. By 16, he had published his first game, and at 17, secured his first tech internship at a startup.\n\n**Academic Excellence**\nAt 18, he founded a tech club to build community and share knowledge. At 19, he published research on CreativeGAN in collaboration with MIT, presented at ASME IDETC/CIE 2021. He graduated at 20 as valedictorian, earning four academic awards and recognition as the best graduate of his class.\n\n**Entrepreneurship**\nAt 21, Rashad founded an AI consulting company, helping businesses implement AI solutions. A year later, at 22, he co-founded Cleve, a venture-backed startup focused on AI-powered productivity tools.\n\n**Speaking & Community**\nRashad is [passionate about education and community building](/about). He has [delivered ${STATS.talks} talks](/speaking) on AI, technology, career development, and startups. He's also a [content creator on TikTok](/create) with ${STATS.followers} followers and ${STATS.views} views, and regularly [judges hackathons](/hackathons) (10+ events). He also runs [buildforpublic.com](https://buildforpublic.com), a social initiative promoting AI literacy and open-source AI projects for social good.\n\n**Personal**\nWhen he's not building or creating, he enjoys [trying new things](/hobbies), [diving](/diving), [reading](/books), [writing](/blog), and [watching movies](/movies). Check out his [curated resources](/resources) and [bookmarks](/bookmarks).`,

        // Level 18: Add hackathon wins and AI resident detail
        `Rashad is an {highlight:${STATS.role}}, entrepreneur, and educator who has been building with technology since {highlight:age 11}. He is currently the co-founder & CTO at {underline:[Cleve](https://cleve.ai)}, where he leads the development of [AI-powered tools](/projects) that have reached over {circle:${STATS.usersLong} users} globally. He's also an {underline:AI Resident at 500 Global}. [Learn more about him](/about) or check out [what he's up to now](/now).\n\n**Early Beginnings**\n[Rashad's unconventional path](/about) started with {highlight:hacking at age 11}, followed by {highlight:entering university at 15} - making him one of the youngest students in his cohort. By 16, he had published his first game, and at 17, secured his first tech internship at a startup.\n\n**Academic Excellence**\nAt 18, he founded a tech club to build community and share knowledge. The following year, at 19, he {box:published research on CreativeGAN} in collaboration with {underline:MIT}, presented at ASME IDETC/CIE 2021. He graduated at 20 as {highlight:valedictorian}, earning {circle:four academic awards} and recognition as the best graduate of his class.\n\n**Entrepreneurship**\nAt 21, Rashad founded an AI consulting company, helping businesses implement AI solutions. A year later, at 22, he co-founded Cleve, a venture-backed startup focused on AI-powered productivity tools.\n\n**Speaking & Community**\nRashad is [passionate about education and community building](/about). He has {box:[delivered ${STATS.talks} talks](/speaking)} on AI, technology, career development, and startups at various institutions and events. He regularly [judges hackathons](/hackathons) (10+ events) and has {circle:[won 5 hackathons](/hackathons)} himself as a participant. He also runs [buildforpublic.com](https://buildforpublic.com), a social initiative promoting AI literacy and open-source AI projects for social good.\n\n**Content Creation**\nAs a [content creator on TikTok](/create), Rashad has built an audience of {circle:${STATS.followersLong} followers} and generated over {circle:${STATS.viewsLong} views} through educational content on AI, tech careers, and productivity.\n\n**Personal Interests**\nWhen he's not building products or creating content, Rashad enjoys [trying new things](/hobbies), [diving](/diving), [reading](/books), [writing](/blog), and [watching movies](/movies). Check out his [curated resources](/resources) and [bookmarks](/bookmarks) for recommendations.`,

        // Level 19: Add impact statement and mission
        `Rashad is an {highlight:${STATS.role}}, entrepreneur, and educator who has been building with technology since {highlight:age 11}. He is currently the co-founder & CTO at {underline:[Cleve](https://cleve.ai)}, where he leads the development of [AI-powered tools](/projects) that have reached over {circle:${STATS.usersLong} users} globally. He's also an {underline:AI Resident at 500 Global}. [Learn more about him](/about) or check out [what he's up to now](/now).\n\n**Early Beginnings**\n[Rashad's unconventional path](/about) started with {highlight:hacking at age 11}, followed by {highlight:entering university at 15} - making him one of the youngest students in his cohort. By 16, he had published his first game, and at 17, secured his first tech internship at a startup.\n\n**Academic Excellence**\nAt 18, he founded a tech club to build community and share knowledge. The following year, at 19, he {box:published research on CreativeGAN} in collaboration with {underline:MIT}, presented at ASME IDETC/CIE 2021. He graduated at 20 as {highlight:valedictorian}, earning {circle:four academic awards} and recognition as the best graduate of his class.\n\n**Entrepreneurship**\nAt 21, Rashad founded an AI consulting company, helping businesses implement AI solutions. A year later, at 22, he co-founded Cleve, a venture-backed startup focused on AI-powered productivity tools. See more of his [projects here](/projects).\n\n**Speaking & Community**\nRashad is [passionate about education and community building](/about). He has {box:[delivered ${STATS.talks} talks](/speaking)} on AI, technology, career development, and startups at various institutions and events. He regularly [judges hackathons](/hackathons) (10+ events) and has {circle:[won 5 hackathons](/hackathons)} himself as a participant. He also runs [buildforpublic.com](https://buildforpublic.com), a social initiative promoting AI literacy and open-source AI projects for social good.\n\n**Content Creation**\nAs a [content creator on TikTok](/create), Rashad has built an audience of {circle:${STATS.followersLong} followers} and generated over {circle:${STATS.viewsLong} views} through educational content on AI, tech careers, and productivity.\n\n**Personal Interests**\nWhen he's not building products or creating content, Rashad enjoys [trying new things](/achievements), [reading](/books), [writing](/blog), and [watch movies](/movies). Check out his [curated resources](/resources) and [bookmarks](/bookmarks) for recommendations on books, movies, tools, and more.\n\n**Impact**\nThrough his companies, talks, and content, Rashad has directly {highlight:impacted over ${STATS.usersLong} people} - whether through products they use, talks they've attended, or content they've consumed. His mission is to {underline:democratize access to AI knowledge} and {underline:empower the next generation of builders}.`
    ],
